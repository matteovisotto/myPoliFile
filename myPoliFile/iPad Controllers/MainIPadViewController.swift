...
//  myPoliFile
//
//  Created by Matteo Visotto on 26/10/21.
//

import Foundation
import UIKit

class MainIPadViewController: BaseViewController {
...
extension MainIPadViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
