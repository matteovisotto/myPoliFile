//
//  CoursesIPadViewController.swift
//  myPoliFile
//
...
class CoursesIPadViewController: BaseViewController {
...
override func viewDidLoad() {
    ...
    collectionViewLayout.estimatedItemSize = CGSize(width: DimensionManager.getCollectionViewCellDimention(width: UIScreen.main.bounds.width, numberOfElementInSmallestRow: 2), height: 10)
...
override func willAnimateRotation(to toInterfaceOrientation: UIInterfaceOrientation, duration: TimeInterval) {
    ...
    (self.collectionView.collectionViewLayout as! UICollectionViewFlowLayout).estimatedItemSize = CGSize(width: DimensionManager.getCollectionViewCellDimention(width: UIScreen.main.bounds.width, numberOfElementInSmallestRow: 2), height: 10)
    self.collectionView.reloadData()
}
}

extension CoursesIPadViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension CoursesIPadViewController: MVTopMenuDelegate, MVTopMenuDataSource {
